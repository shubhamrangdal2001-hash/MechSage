...
from dev.agentic.tools import rag_retrieve
from dev.agentic.fault_signatures import lookup_fault_hypothesis
...
def _get_model() -> genai.GenerativeModel:
    """Lazy-init the strong Gemini Pro model for Diagnostics."""
