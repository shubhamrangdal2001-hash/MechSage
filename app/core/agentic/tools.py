...
def ml_predict(asset_id: str, raw_telemetry: dict, dataset_id: str = "FD001") -> dict:
    ...
    try:
        rul_model_path = f"ML/models/best_rul_model_{dataset_id}.joblib"
        anomaly_model_path = f"ML/models/best_anomaly_model_{dataset_id}.joblib"
