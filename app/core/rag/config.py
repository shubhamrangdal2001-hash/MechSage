...
class RAGConfig:
    ...
    llm_provider: str = "openrouter"  # Uses OPENROUTER_API_KEY env var
    openrouter_model: str = "google/gemini-2.5-pro"  # Model slug used for generation and judging
    openrouter_base_url: str = "https://openrouter.ai/api/v1"

    @property
    def gemini_model(self) -> str:
        """Alias for openrouter_model — the Gemini model slug used for LLM calls."""
